...
import { getProjectGithub } from "../controllers/github.controller.js";
...
// GET /api/projects/:id/github — public, like the project detail page
// itself; repo stats aren't sensitive information
router.get("/:id/github", validateObjectId("id"), loadProject, getProjectGithub);
