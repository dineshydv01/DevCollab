...
export const env = {
  ...
  // Optional. Without it, GitHub API calls are unauthenticated
  // (60 requests/hour per IP — fine for local dev/demo). With a
  // personal access token, that rises to 5,000/hour. Never required.
